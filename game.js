...
// Keep keyboard input system for debugging (optional)
var keys = {};
...
function init() {
    ...
    // Don't create players here — they're created when phones connect via connecthandler()
}
...
// Initialize the map immediately so platforms are visible
init()
